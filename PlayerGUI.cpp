...
{
	// Add buttons
	for (auto* btn : { &loadButton, &restartButton , &stopButton , &playButton , &loopButton , &muteButton , &goStartButton , &goEndButton})
	{
...
void PlayerGUI::resized()
{
	...
	goStartButton.setBounds(640, y, 80, 40);
	goEndButton.setBounds(740, y, 80, 40);
